...
__decorate([
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, lot_dto_1.PublishLotDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Недостаточно прав' }),
    (0, common_1.Post)(':id/select-winner'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Отмена лота' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Лот отменен' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Нельзя отменить опубликованный лот' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Недостаточно прав' }),
    ...
    __metadata("design:returntype", void 0)
], LotsController.prototype, "cancel", null);
