...
export declare class EscrowService {
    ...
    create(userId: string, createEscrowDto: CreateEscrowDto): Promise<{
        lot: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    deposit(userId: string, escrowId: string, depositDto: DepositEscrowDto): Promise<{
        lot: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    withdraw(escrowId: string, withdrawDto: WithdrawEscrowDto): Promise<{
        escrow: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    close(userId: string, escrowId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: string;
    ...
    calculatePlatformFee(escrowId: string): Promise<{
        totalPayouts: number;
        platformFee: number;
        feeApplied: boolean;
    }>;
    applyPlatformFee(escrowId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: string;
